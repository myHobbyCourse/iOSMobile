...
@interface ProfileComlateVC ()

@end

@implementation ProfileComlateVC
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [self updateToGoogleAnalytics:@"Profile completeness Screen"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 0) {
        ...
        imgV.image = [UIImage imageNamed:[NSString stringWithFormat:@"%d_",progress]];
        return cell;
