...
- (void) setData:(Course*) course customCell:(CourseTableViewCell *)cell isscroll:(BOOL) flag {
    ...
    {
        UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(_screenSize.width * i++, 0, cell.frame.size.width,(190 * _heighRatio))];
    ...
    imgScroll.contentSize = CGSizeMake(course.images.count * _screenSize.width,(190 * _heighRatio) - 5);
...
- (void) setData:(CourseDetail*) course customCell:(CourseTableViewCell *)cell
{
    ...
    imgScroll.contentSize = CGSizeMake(course.field_deal_image.count * _screenSize.width,(190 * _heighRatio) - 5);
