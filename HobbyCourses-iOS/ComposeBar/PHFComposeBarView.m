...
CGFloat const kHorizontalSpacing          = 8.0f; //8.0f;
CGFloat const kHorizontalSpacingForTextView = 41.0f; //8.0f;
...
CGFloat const kButtonRightMargin          = 5.0f; // -2
CGFloat const kButtonBottomMargin         =  15.0f; // 8.0f
...
@property (strong, nonatomic, readonly) UIView *backgroundView; // was UIToolBar
@property (strong, nonatomic, readonly) UIView *topLineView;
@property (strong, nonatomic, readonly) UIImageView *sideImgView;
...
- (UIView *)topLineView {
    if (!_topLineView) {
        ...
        [_topLineView setBackgroundColor:[UIColor colorWithWhite:0.90f alpha:0.50f]];
        [_topLineView setAutoresizingMask:UIViewAutoresizingFlexibleWidth];
        _topLineView.alpha = 0.15;
    }
...
- (UIView *)backgroundView {
    if (!_backgroundView) {
        ...
        // changed
        //[_backgroundView setTintColor:[UIColor muDirtyPurpleColor]];
//        _backgroundView.backgroundColor = [UIColor muDirtyPurpleColor];
        //[_backgroundView setBarTintColor:[UIColor muDirtyPurpleColor]];
        //[_backgroundView setBackgroundImage:nil forToolbarPosition:UIBarPositionAny barMetrics:UIBarMetricsDefault];
        //[_backgroundView setShadowImage:nil forToolbarPosition:UIBarPositionAny];
...
//        [_backgroundView setBarStyle:UIBarStyleDefault];
//        [_backgroundView setTranslucent:YES];
//        // [_backgroundView setTintColor:[UIColor whiteColor]]; // changed
//        [_backgroundView setTintColor:[UIColor muDirtyPurpleColor]];
//        [_backgroundView setBarTintColor:[UIColor muDirtyPurpleColor]];
//        [_backgroundView setBackgroundImage:nil forToolbarPosition:UIBarPositionAny barMetrics:UIBarMetricsDefault];
//        [_backgroundView setShadowImage:nil forToolbarPosition:UIBarPositionAny];
...
- (UIButton *)button {
    if (!_button) {
        ...
        _button.backgroundColor = [UIColor colorFromHexString:@"F52375"];

        UIColor *enabledColor = [UIColor whiteColor];
        //[UIColor colorWithHue:211.0f/360.0f saturation:1.0f brightness:1.0f alpha:1.0f];
...
//        [label setFont:[UIFont muAvenirMedium:12]];
    }
...
- (UIButton *)textContainer {
    if (!_textContainer) {
        CGRect textContainerFrame = CGRectMake(kHorizontalSpacingForTextView,
                                               kTextContainerTopMargin,
                                               [self bounds].size.width - kHorizontalSpacing * 3 - kButtonRightMargin - 33.0,
        ...
        UIColor *borderColor = [UIColor clearColor];
                                //colorWithHue:240.0f/360.0f saturation:0.02f brightness:0.8f alpha:1.0f];
...
//        [_textView setFont:[UIFont muAvenirHeavy:15]];
...
//        [_placeholderLabel setFont:[UIFont muAvenirLight:15]];
//        [_placeholderLabel setTextColor:[UIColor muFadedPurpleColor2]];
         //[UIColor colorWithHue:240.0f/360.0f saturation:0.02f brightness:0.8f alpha:1.0f]];
...
@synthesize sideImgView = _sideImgView;
- (UIImageView *)sideImgView {
    if (!_sideImgView) {
        _sideImgView = [[UIImageView alloc] initWithFrame:CGRectZero];
        _sideImgView.image = [UIImage imageNamed:@"commentsIcon"];
        _sideImgView.frame = CGRectMake(9, 7, 33.3, 33.3);
    }
    return _sideImgView;
}
...
//                                            kUtilityButtonHeight)];
        [_utilityButton setFrame:CGRectZero];
...
- (void)setup {
    ...
    //[self addSubview:[self sideImgView]]; // added by jigar
...
- (void)updateButtonEnabled {
    ...
    [[self button] setHidden:false]; //!enable
}
